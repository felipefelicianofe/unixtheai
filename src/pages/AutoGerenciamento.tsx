                            ...
                            <div className="p-4 space-y-4 border-t border-border/10">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-4 gap-2">
                                      ...
                                      <div className="p-2 rounded bg-red-500/5 border border-red-500/20">
                                        <div className="text-[9px] text-red-500/70 uppercase">Stop Loss</div>
                              ...
                              {h.full_result && (
                                <div className="mt-4 pt-4 border-t border-border/50">
                                  <AnalysisResults data={typeof h.full_result === 'string' ? (() => { try { return JSON.parse(h.full_result as string); } catch { return h.full_result; } })() : h.full_result} onNewAnalysis={() => setExpandedRowId(null)} />
                                </div>
                              )}
                            </div>
                          </motion.div>
