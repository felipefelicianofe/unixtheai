...
serve(async (req) => {
  ...
  try {
    ...
    // ========== RESET MODE ==========
    if (mode === "reset") {
      await supabase.from("refinement_weights").delete().neq("id", "00000000-0000-0000-0000-000000000000");
      await supabase.from("indicator_performance").delete().neq("id", "00000000-0000-0000-0000-000000000000");
